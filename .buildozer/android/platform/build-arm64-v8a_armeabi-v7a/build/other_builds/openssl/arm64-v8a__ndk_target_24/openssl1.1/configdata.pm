...
our %config = (
  ...
  ARFLAGS => [ "rs" ],
  CC => "clang",
  CFLAGS => [ "-target aarch64-linux-android24 -fomit-frame-pointer -march=armv8-a" ],
  CPPDEFINES => [ "__ANDROID_API__=24" ],
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=24 -I/home/hex/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/aarch64-linux-android -I/home/hex/Documents/projects/AndroidDebug/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/myapp/arm64-v8a/include/python3.8" ],
  CPPINCLUDES => [  ],
  CXX => "/home/hex/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android24 -fomit-frame-pointer -march=armv8-a",
  CXXFLAGS => [ "-target aarch64-linux-android24 -fomit-frame-pointer -march=armv8-a" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/home/hex/Documents/projects/AndroidDebug/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/libs_collections/myapp/arm64-v8a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
  ...
  perl_version => "5.32.1",
  perlargv => [ "shared", "no-dso", "no-asm", "android-arm64", "-D__ANDROID_API__=24" ],
  perlenv => {
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -target aarch64-linux-android -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-24/arch-arm64",
  chacha_asm_src => "chacha_enc.c",
  chacha_obj => "chacha_enc.o",
  cmll_asm_src => "camellia.c cmll_misc.c cmll_cbc.c",
  cmll_obj => "camellia.o cmll_misc.o cmll_cbc.o",
  cppflags => "-D__ANDROID_API__=24 -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include/aarch64-linux-android -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include",
  cpuid_asm_src => "mem_clr.c",
  cpuid_obj => "mem_clr.o",
  cxxflags => "-std=c++11 -pthread  -target aarch64-linux-android -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-24/arch-arm64",
  defines => [  ],
